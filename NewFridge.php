...
<head>
    ...
    <title>Smart Refrigerators</title>
...
<nav class="navbar">
    ...
    <div class="ad">
        <img src="images/fridgePgAd.png" alt="Advertisement">
    </div>

    <div class="p_header">
        <h1>KEEP YOUR FOOD FRESH WITH OUR SMART REFRIGERATORS</h1>
    </div>
    ...
    <div class="prod_links">
        <div class="product-grid">
            <?php
            // Fetch products from the refrigerators table
            ...
            if ($result->num_rows > 0) {
                while ($row = $result->fetch_assoc()) {
                    ...
                    echo '<a href="NewREFDetails.php?id=' . htmlspecialchars($row['id']) . '">';
