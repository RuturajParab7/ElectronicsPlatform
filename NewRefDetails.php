...
// Prepare and execute the query for refrigerators
$stmt = $conn->prepare("SELECT * FROM refrigerators WHERE id = ?");
...
<script>
   ...
   document.getElementById('buy-now-btn').addEventListener('click', () => {
    ...
    window.location.href = `payement.html?id=</?php echo $product['id']; ?>&type=refrigerators`;
});
